...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `mercury backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - mercury_home (str): The active HERMES_HOME directory path. Use this
    ...
    def save_config(self, values: Dict[str, Any], mercury_home: str) -> None:
        ...
        ``mercury_home`` is the active HERMES_HOME directory path.
    ...
    def backup_paths(self) -> List[str]:
        ...
        ``mercury backup`` only walks HERMES_HOME, so any provider state kept
        ...
        of the archive, and ``mercury import`` restores them to their original
