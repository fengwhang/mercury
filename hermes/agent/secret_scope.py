...
def load_env_file(env_path: Path) -> Dict[str, str]:
    ...
    ``set_secret_scope``. Parses the small KEY=VALUE subset Mercury writes
    ...
    ``mercury_cli.config._parse_env_value``) but never mutates the process
    ...
    # Parse values with the canonical Mercury parser: save_env_value
    ...
    from mercury_cli.config import _parse_env_value
