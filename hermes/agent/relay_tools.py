"""Core NeMo Relay adapter for Mercury tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Mercury tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Mercury Relay tool execution cannot run on an active event-loop thread"
    )
