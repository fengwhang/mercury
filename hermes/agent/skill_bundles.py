...
Storage
-------
Bundles live in ``~/.mercury/skill-bundles/*.yaml`` (and the equivalent
...
- :func:`list_bundles` — return rich info for display (``mercury bundles``)
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `mercury bundles` CLI subcommand.
# ---------------------------------------------------------------------------
