        ...
        with httpx.Client(timeout=timeout) as client:
            resp = client.post(
                ...
                headers={
                    ...
                    "X-Goog-Api-Client": f"mercury-agent/{_HERMES_VERSION}",
                },
            )
...
_FREE_TIER_GUIDANCE = (
    ...
    "for Gemini Flash models). Mercury typically makes 3-10 API calls per user turn, "
...
_STANDARD_KEY_GUIDANCE = (
    ...
    "GOOGLE_API_KEY in ~/.mercury/.env and restart your session. "
...
def _thinking_requests_output_headroom(thinking_config: Any) -> bool:
    ...
    Mercury ``max_tokens`` of 4096/16384 is enough for visible text, but
...
class GeminiNativeClient:
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": f"mercury-agent/{_HERMES_VERSION} (gemini-native)",
            "X-Goog-Api-Client": f"mercury-agent/{_HERMES_VERSION}",
        }
