...
# ``data:`` field before Mercury receives a completion chunk.  Keeping this
...
# See: https://github.com/NousResearch/mercury-agent/issues/69078
...
#
# See: https://github.com/NousResearch/mercury-agent/issues/27344
...
# case: a stream dies mid-response and Mercury persists a content-less
...
# Request parameters that Mercury sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # mercury_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from mercury_cli.plugins import get_plugin_error_classification
