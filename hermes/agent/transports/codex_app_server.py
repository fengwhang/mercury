...
projection into Mercury' display, approval bridging, transcript projection into
...
"codex_app_server"`. Mercury' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # `os.environ.copy()` also handed it every Tier-1 Mercury secret — gateway
        ...
        spawn_env = mercury_subprocess_env(inherit_credentials=True)
        if env:
    ...
    def initialize(
        self,
        client_name: str = "mercury",
        client_title: str = "Mercury",
