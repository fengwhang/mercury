...
def _ensure_file_checkpoint(
    ...
    # which can differ from the Mercury process cwd (notably in Docker).  Resolve
...
def _flush_session_db_after_tool_progress(
    ...
    *,
    ...
    current Mercury process before the normal turn-end persistence path runs.
...
def _run_agent_tool_execution_middleware(
    ...
    *,
    ...
    """Run Relay rewrites before Mercury policy and dispatch exactly once."""
