...
def _assert_path_preserved(env):
    """Original PATH entries survive sanitization; the mercury console-script
    ...
    mercury_bin = _resolve_hermes_bin_dir()
    if mercury_bin and path_val != "/usr/bin:/bin":
        assert path_val.startswith(mercury_bin + os.pathsep), path_val
