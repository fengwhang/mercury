...
stale-module ImportError after ``mercury update``.
"""
...
class TestModelSwitchSkewGuard:
    ...
    def test_guard_message_names_revs_and_restart(self, monkeypatch):
        ...
        assert "mercury gateway restart" in msg
...
class TestModelOptionsSkewGuard:
    ...
    Regression for #86207: a dashboard kept alive across ``mercury update``
    ...
    def test_stale_dashboard_returns_503_and_skips_payload_build(self, monkeypatch):
        ...
        payload_calls: list = []
        monkeypatch.setattr(
            "mercury_cli.inventory.build_model_options_payload",
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("mercury_cli.inventory.load_picker_context", lambda: {})
