"""Session <-> workspace grouping key (mercury_state.workspace_key).

The key is what `mercury sessions list --workspace` groups/filters on. It is a
...
from mercury_state import workspace_key
