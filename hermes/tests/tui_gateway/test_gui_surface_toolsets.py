...
locally, one reached over SSH, one behind a plain URL+token, or Mercury Cloud —
...
model "You are chatting inside the Mercury desktop app".
...
class TestSurfaceResolution:
    ...
    def test_desktop_env_alone_does_not_grant_them(self, no_desktop_env):
        ...
        The embedded terminal pane runs `mercury --tui` against this same
