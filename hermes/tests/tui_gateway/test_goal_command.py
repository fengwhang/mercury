...
@pytest.fixture()
def server(mercury_home, monkeypatch):
    ...
    monkeypatch.setattr(mod, "_hermes_home", mercury_home)
...
def test_moa_bare_returns_usage(server, session, mercury_home):
    _write_moa_config(mercury_home, """
moa:
