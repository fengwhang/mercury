...
def test_session_store_default_db_uses_runtime_hermes_home(tmp_path, monkeypatch):
    ...
    mercury_state before a fixture redirected HERMES_HOME used to pin every
    default SessionDB() at the developer's real ~/.mercury/state.db.
    """
...
class TestReadmeSentinel:
    ...
    def test_save_writes_readme_sentinel_first(self, tmp_path):
        ...
        assert "mercury sessions list" in raw["_README"]
