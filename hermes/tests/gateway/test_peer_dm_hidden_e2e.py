"""E2E: ``mercury peer dm`` against a REAL api_server gateway whose canonical
Bot Chat session is HIDDEN (issue #91583).

Two real MERCURY homes in spirit: the "peer" side is a real
...
the stock ``mercury peer dm`` client code (``mercury_cli.subcommands.peer``),
