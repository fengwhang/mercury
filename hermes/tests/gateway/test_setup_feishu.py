...
def _run_setup_feishu(
    *,
    ...
    with patch("mercury_cli.config.save_env_value", side_effect=mock_save), \
         patch("mercury_cli.config.get_env_value", side_effect=mock_get), \
         patch("mercury_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("mercury_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("mercury_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("mercury_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("mercury_cli.cli_output.print_header"), \
         patch("mercury_cli.cli_output.print_info"), \
         patch("mercury_cli.cli_output.print_success"), \
         patch("mercury_cli.cli_output.print_warning"), \
         patch("mercury_cli.cli_output.print_error"), \
