...
def test_iron_proxy_swaps_authorization_header_end_to_end(mercury_home, monkeypatch):
...
def test_iron_proxy_swaps_x_api_key_header_end_to_end(mercury_home, monkeypatch):
...
def test_iron_proxy_management_reload_end_to_end(mercury_home, monkeypatch):
