...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and mercury-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # mercury-agent (tests/skills/)
]
