"""Regression test: mercury update must not load cryptography eagerly."""
...
assert 'mercury_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running mercury update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so mercury_cli is importable,
...
import mercury_cli.main
from mercury_cli.update_cmd import _cmd_update_check
