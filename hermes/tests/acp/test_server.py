...
class TestSessionOps:
    ...
    async def test_new_session_returns_authenticated_cross_provider_model_state(self):
        ...
        with (
            patch("mercury_cli.inventory.load_picker_context", return_value=picker_context),
            patch("mercury_cli.inventory.build_models_payload", return_value=payload) as build_payload,
        ):
