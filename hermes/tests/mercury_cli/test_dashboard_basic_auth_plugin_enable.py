...
from mercury_cli.dashboard_auth import clear_providers, list_providers
from mercury_cli.plugins import PluginManager, discover_plugins
...
class TestBasicProviderLoadsAfterUnblock:
    def test_disabled_basic_blocks_registration(self, mercury_home, monkeypatch):
    ...
    def test_unblock_then_rediscover_registers_provider(
        ...
        _write_config(mercury_home, cfg)
