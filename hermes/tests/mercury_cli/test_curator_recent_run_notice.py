...
The notice prints the most recent curator run summary on `mercury update`,
...
session start) so users normally never see the rename map. `mercury update`
