"""Tests for the shared byte formatter (mercury_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from mercury_cli.backup import _format_size as backup
    from mercury_cli.checkpoints import _fmt_bytes as checkpoints
    from mercury_cli.doctor import _human_bytes as doctor
