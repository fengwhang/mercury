...
the *mutation* side: `mercury plugins enable/disable` must resolve a bare name
...
class TestResolvePluginKey:
    ...
    def test_full_key_resolves_to_itself(self, mock_user, mock_bundled, nested_plugin_env):
        from mercury_cli.plugins_cmd import _resolve_plugin_key
...
class TestEnableDisableNested:
    @patch("mercury_cli.plugins.get_bundled_plugins_dir")
    @patch("mercury_cli.plugins_cmd._plugins_dir")
    @patch("mercury_cli.plugins_cmd._save_disabled_set")
    @patch("mercury_cli.plugins_cmd._save_enabled_set")
    @patch("mercury_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("mercury_cli.plugins_cmd._get_enabled_set", return_value=set())
    def test_enable_bare_name_writes_key(
        ...
        from mercury_cli.plugins_cmd import cmd_enable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
...
class TestEnableToolOverrideConsent:
    ...
    @patch("mercury_cli.plugins.get_bundled_plugins_dir")
    @patch("mercury_cli.plugins_cmd._plugins_dir")
    @patch("mercury_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("mercury_cli.plugins_cmd._save_disabled_set")
    @patch("mercury_cli.plugins_cmd._save_enabled_set")
    @patch("mercury_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("mercury_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `mercury plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from mercury_cli.plugins_cmd import _run_composite_fallback
