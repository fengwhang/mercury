"""Tests for mercury_cli.security_advisories.
...
import mercury_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full mercury_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "mercury_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
