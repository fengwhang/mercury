...
hand-rolled parsers — ``mercury_cli.config.load_env``,
``mercury_cli.main._has_any_provider_configured``, and
...
def test_config_load_env_strips_export_prefix(tmp_path):
    from mercury_cli.config import invalidate_env_cache, load_env
...
def test_has_any_provider_configured_with_export_prefix(tmp_path, monkeypatch):
    ...
    import mercury_cli.main as hmain
