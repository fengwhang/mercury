...
class TestCallerIntegration:
    ...
    @patch("mercury_cli.copilot_auth.get_copilot_api_token", return_value=("exchanged_jwt", None))
...
class TestDeriveBaseUrlFromProxyEp:
    ...
    def test_extracts_enterprise_url(self):
        from mercury_cli.copilot_auth import _derive_base_url_from_proxy_ep
...
class TestExchangeFailureFastPath:
    ...
    def test_transient_failure_still_retries_then_caches(self, mock_urlopen, mock_sleep):
        import mercury_cli.copilot_auth as mod
        from mercury_cli.copilot_auth import exchange_copilot_token, _token_fingerprint
    ...
    def test_evict_clears_negative_cache(self):
        import mercury_cli.copilot_auth as mod
        from mercury_cli.copilot_auth import evict_cached_exchanged_token, _token_fingerprint
