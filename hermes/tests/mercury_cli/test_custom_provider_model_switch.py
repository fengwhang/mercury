...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        from mercury_cli.main import _model_flow_custom
        ...
        with patch(
            ...
            return_value={
             ...
             patch("mercury_cli.secret_prompt.masked_secret_prompt", return_value="sk-new"), \
             patch("mercury_cli.main._prompt_custom_api_mode_selection", return_value=""), \
             patch(
                 "builtins.input",
                 side_effect=[
    ...
    def test_env_template_api_key_is_preserved_in_model_config(self, config_home, monkeypatch):
        ...
        with patch("mercury_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]) as mock_fetch, \
             patch("mercury_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
    ...
    def test_key_env_custom_provider_persists_reference_not_secret(self, config_home, monkeypatch):
        ...
        with patch("mercury_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]), \
             patch("mercury_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_env_ref_base_url_preserves_api_key_ref_through_picker(
        ...
        with patch("mercury_cli.main._prompt_provider_choice",
                   side_effect=_pick_neuralwatt), \
             patch("mercury_cli.models.fetch_api_models",
...
class TestCustomProviderDiscoverModels:
    """#18726: honor ``discover_models: false`` in the terminal ``mercury model``
    ...
    def test_discover_false_with_only_singular_model_skips_probe(self, config_home):
        ...
        with patch("mercury_cli.models.fetch_api_models") as mock_fetch, \
             patch("mercury_cli.models.fetch_ollama_local_models") as mock_ollama, \
             patch("mercury_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
