...
class TestFetchOpenRouterModels:
    ...
    def test_falls_back_to_static_snapshot_on_fetch_failure(self, monkeypatch):
        ...
        with patch("mercury_cli.model_catalog.get_curated_openrouter_models", return_value=None), \
             patch("mercury_cli.models._urlopen_model_catalog_request", side_effect=OSError("boom")):
    ...
    def test_filters_out_models_without_tool_support(self, monkeypatch):
        ...
        monkeypatch.setattr(_models_mod, "_openrouter_catalog_cache", None)
        with (
            patch("mercury_cli.model_catalog.get_curated_openrouter_models", return_value=[]),
            patch("mercury_cli.models._urlopen_model_catalog_request", return_value=_Resp()),
        ):
            models = fetch_openrouter_models(force_refresh=True)
...
class TestCheckNousFreeTierCache:
    ...
    @patch("mercury_cli.nous_account.get_nous_portal_account_info")
...
class TestNousRecommendedModels:
    ...
    def test_fetch_caches_per_portal_url(self):
        ...
        with patch("mercury_cli.models._urlopen_model_catalog_request", return_value=mock_cm) as mock_urlopen:
...
class TestLocalOllamaModelDiscovery:
    ...
    def test_native_tags_cache_expires(self, monkeypatch):
        from mercury_cli.models import fetch_ollama_local_models
        ...
        try:
            ...
            monkeypatch.setattr("mercury_cli.models.time.monotonic", lambda: 301.0)
    ...
    def test_runtime_error_from_config_load_does_not_escape_ollama_helpers(self):
        ...
        from mercury_cli.models import _get_ollama_base_url, should_use_ollama_native_catalog

        with patch("mercury_cli.config.load_config", side_effect=RuntimeError("bad home")), patch(
            "mercury_cli.models.probe_ollama_local_models",
            return_value=None,
        ):
    ...
    def test_probe_ollama_models_malformed_base_url_returns_none(self):
        ...
        from mercury_cli.models import probe_ollama_local_models
    ...
    def test_fetch_ollama_models_preserves_probe_failure(self):
        ...
        with patch("mercury_cli.models.probe_ollama_local_models", return_value=None):
    ...
    def test_ollama_port_detection_requires_working_api_tags(self):
        ...
        with patch("mercury_cli.models.probe_ollama_local_models", return_value=["qwen3:1.7b"]):
    ...
    def test_provider_model_ids_ollama_cloud_config_uses_generic_catalog(self):
        ...
        ), patch("mercury_cli.models.fetch_ollama_local_models") as fetch_local, patch(
    ...
    def test_native_ollama_catalog_uses_configured_key_env(self, monkeypatch):
        from mercury_cli.models import _get_ollama_request_headers
    ...
    def test_ollama_cache_fingerprint_does_not_probe_custom_endpoint(self):
        from mercury_cli.models import _credential_fingerprint
        ...
        ), patch("mercury_cli.models.probe_ollama_local_models") as probe_ollama:
    ...
    def test_clear_provider_models_cache_clears_ollama_native_tags_cache(self):
        import mercury_cli.models as models
    ...
    def test_picker_user_provider_verifies_ambiguous_ollama_port(self):
        ...
        with patch("mercury_cli.config.load_config", return_value={"providers": {}}), patch(
            "mercury_cli.models.should_use_ollama_native_catalog",
            return_value=True,
        ), patch(
            "mercury_cli.models.fetch_ollama_local_models",
            return_value=["qwen3:1.7b"],
        ), patch("mercury_cli.models.fetch_api_models", return_value=[]) as fetch_api:
            rows = list_authenticated_providers(
    ...
    def test_named_custom_model_flow_discovers_ollama_api_tags(self):
        ...
        try:
            with patch("mercury_cli.config.load_config", return_value=config), patch(
                "mercury_cli.config.save_config"
            ), patch("mercury_cli.auth._save_model_choice"), patch(
                "mercury_cli.auth.deactivate_provider"
            ), patch("mercury_cli.main._save_custom_provider"), patch(
                "mercury_cli.curses_ui.curses_radiolist",
    ...
    def test_model_validation_ollama_cloud_config_does_not_use_local_tags(self):
        ...
        ), patch("mercury_cli.models.probe_ollama_local_models") as probe_ollama, patch(
    ...
    def test_switch_model_on_current_ollama_custom_endpoint_keeps_base_url(self):
        ...
        try:
            with patch(
                ...
                "mercury_cli.model_switch.get_model_info",
                return_value=None,
            ):
                result = switch_model(
    ...
    def test_ollama_root_matching_is_case_insensitive_for_hostnames(self):
        from mercury_cli.models import _same_ollama_native_root
    ...
    def test_ollama_host_environment_forms_are_normalized(self, monkeypatch):
        from mercury_cli.models import _get_ollama_base_url, _root_for_ollama_native_api
    ...
    def test_ollama_failed_probe_is_cached_briefly(self):
        ...
        with patch(
            "mercury_cli.models._urlopen_model_catalog_request",
    ...
    def test_switch_model_direct_ollama_alias_preserves_matching_origin_api_key(self):
        import mercury_cli.model_switch as model_switch
