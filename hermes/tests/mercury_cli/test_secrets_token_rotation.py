"""Tests for `mercury secrets bitwarden token` / `mercury secrets onepassword token`.
...
from mercury_cli import onepassword_secrets_cli as op_cli
from mercury_cli import secrets_cli as bw_cli
