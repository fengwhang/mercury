"""Tests for the shared tar.gz writer (``mercury_cli.archive_safe.make_targz``).

``make_targz`` backs both ``mercury profile export`` and ``mercury kanban
...
from mercury_cli.archive_safe import make_targz
