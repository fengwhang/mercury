...
class TestFetchApiModels:
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("mercury_cli.models._urlopen_model_catalog_request", side_effect=_fake_urlopen):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch("mercury_cli.models._urlopen_model_catalog_request", return_value=_Resp()) as mock_urlopen:
...
class TestValidateApiFallback:
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("mercury_cli.models._urlopen_model_catalog_request", return_value=mock_resp):
    ...
    def test_validate_lmstudio_distinguishes_auth_failure(self):
        ...
        with patch("mercury_cli.models._urlopen_model_catalog_request", side_effect=http_error):
...
class TestValidateCodex900kVariants:
    """`-900k` is a Mercury picker convention: valid variants come from the
    ...
    def test_catalog_listed_variant_accepted(self):
        with patch("mercury_cli.models.provider_model_ids", return_value=self._CATALOG):
    ...
    def test_valid_variant_missing_from_catalog_still_accepted(self):
        ...
        with patch("mercury_cli.models.provider_model_ids", return_value=["gpt-5.6-sol"]):
            result = validate_requested_model("gpt-5.6-sol-900k", "openai-codex")
        assert result["accepted"] is True
...
class TestValidateRequestedModelNousPortalRecommendations:
    ...
    hardcoded curated catalog -- even though `mercury chat` already accepts
    ...
    def _validate_nous(self, model, api_models=None, portal_payload=None, portal_raises=False):
        ...
        with patch("mercury_cli.models.fetch_api_models", return_value=api_models), \
             patch("mercury_cli.models.probe_api_models", return_value=probe_payload), \
             patch("mercury_cli.models.fetch_nous_recommended_models", side_effect=_fetch_portal), \
             patch("mercury_cli.models._resolve_nous_portal_url", return_value="https://portal.nousresearch.com"), \
             patch("mercury_cli.models._model_in_provider_catalog", return_value=False):
    ...
    def test_non_nous_provider_does_not_consult_portal_feed(self):
        ...
        with patch("mercury_cli.models.fetch_api_models", return_value=["some/other-model"]), \
             patch("mercury_cli.models.probe_api_models", return_value=probe_payload), \
             patch("mercury_cli.models.fetch_nous_recommended_models") as mock_portal, \
             patch("mercury_cli.models._model_in_provider_catalog", return_value=False):
    ...
    def test_curated_catalog_hit_short_circuits_before_portal_check(self):
        ...
        with patch("mercury_cli.models.fetch_api_models", return_value=api_models), \
             patch("mercury_cli.models.probe_api_models", return_value=probe_payload), \
             patch("mercury_cli.models._model_in_provider_catalog", return_value=True), \
             patch("mercury_cli.models.fetch_nous_recommended_models") as mock_portal:
