...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`mercury_cli.slash_exec.EXECUTORS`, and
...
from mercury_cli.commands import COMMAND_REGISTRY, resolve_command
from mercury_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
