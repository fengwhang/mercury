"""Tests for `_can_open_graphical_browser()` in mercury_cli.auth.

Guards the fix for the May 2026 report where `mercury auth add xai-oauth`
...
from mercury_cli.auth import _can_open_graphical_browser
