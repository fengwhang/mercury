"""Regression: ``mercury update`` should take a managed checkout off autocrlf=true.
...
``mercury update`` has to repair them.
...
from mercury_cli.update_cmd import _normalize_managed_eol
