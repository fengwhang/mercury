"""Tests for ``mercury approvals suggest`` (mercury_cli/approvals_suggest.py).

Approval history in Mercury is implied, not ledgered: the session DB
...
from mercury_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
