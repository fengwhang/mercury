...
The oneshot path builds its AIAgent directly (bypassing MercuryCLI), so the
...
from mercury_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
