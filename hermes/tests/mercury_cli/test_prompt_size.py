"""Tests for the ``mercury prompt-size`` diagnostic (issue #34667)."""
...
from mercury_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(mercury_home, memory_text="", user_text=""):
    mem_dir = mercury_home / "memories"
...
def _seed_skill(mercury_home, name, description):
    skill_dir = mercury_home / "skills" / "demo" / name
