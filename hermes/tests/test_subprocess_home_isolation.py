...
Mercury state stays profile-scoped through HERMES_HOME. Host subprocesses should
...
See: https://github.com/NousResearch/mercury-agent/issues/25114
See: https://github.com/NousResearch/mercury-agent/issues/36144
See: https://github.com/NousResearch/mercury-agent/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def _host_mode(self, monkeypatch):
        monkeypatch.setattr(mercury_constants, "is_container", lambda: False)
    ...
    def test_host_auto_keeps_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        mercury_home = real_home / ".mercury" / "profiles" / "coder"
    ...
    def test_real_mode_repairs_parent_home_already_pointing_at_profile(self, tmp_path, monkeypatch):
        ...
        from mercury_constants import get_subprocess_home, get_real_home
