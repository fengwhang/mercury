...
we don't pay the full MercuryCLI.__init__ cost; a synthetic spritesheet exercises
...
def _make_cli():
    ...
    # Transient-beat + reasoning state (set by MercuryCLI.__init__ in production).
    cli_obj._pet_event = ""
