...
# tests/mercury_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("mercury_cli.lifecycle.invoke_hook")
@patch("mercury_cli.lifecycle.finalize_session")
