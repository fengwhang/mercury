...
Damien's incident (Discord, 2026-05-28): a long Mercury session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``mercury_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "mercury_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "mercury_state"
