...
def isolated_home(monkeypatch):
    ...
    test_home = tempfile.mkdtemp(prefix="mercury_test_31179_")
    mercury_home = os.path.join(test_home, ".mercury")
    os.makedirs(mercury_home)
...
def _fresh_modules():
    """Drop cached mercury modules so each test reloads against current env."""
    _drop_reload_targets()
