...
def mercury_home(monkeypatch):
    ...
    """
    td = tempfile.mkdtemp(prefix="mercury-reload-skills-")
...
class TestReloadSkillsHelper:
    ...
    def test_detects_removed_skill_carries_description(self, mercury_home):
        from agent.skill_commands import reload_skills

        skill_dir = _write_skill(mercury_home / "skills", "demo", "soon to be gone")
    ...
    def test_does_not_invalidate_prompt_cache_snapshot(self, mercury_home):
