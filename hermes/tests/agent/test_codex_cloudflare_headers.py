...
The official Codex endpoint must receive Mercury' own harness identity, rather
...
These tests pin:
- the required Mercury originator
- the versioned Mercury User-Agent
...
class TestPrimaryClientWiring:
    ...
    def test_apply_client_headers_on_base_url_change(self):
        ...
        with patch("run_agent.OpenAI") as mock_openai:
            ...
            assert headers.get("originator") == "mercury-agent"
