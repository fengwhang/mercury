...
_ISSUER = "https://auth.example.com/application/o/mercury"
_CLIENT_ID = "mercury-dashboard"
...
class TestStartLogin:
    ...
    def test_returns_login_start(self, provider):
        result = provider.start_login(
            redirect_uri="https://mercury.example/auth/callback"
        )
    ...
    def test_authorize_url_has_required_params(self, provider):
        ...
        assert params["redirect_uri"] == "https://mercury.example/auth/callback"
...
class TestPluginRegister:
    ...
    def test_config_load_failure_falls_through(self, monkeypatch):
        ...
        monkeypatch.setattr("mercury_cli.config.load_config", _broken)
        ctx = MagicMock()
