...
The unit tests in tests/mercury_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned mercury-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/mercury")
from mercury_cli.service_manager import S6ServiceManager
