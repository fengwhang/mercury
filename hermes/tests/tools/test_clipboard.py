...
class TestIsWsl:
    def setup_method(self):
        # _is_wsl is mercury_constants.is_wsl; reset the function's own module
        # globals so this stays stable even if mercury_constants was imported
...
class TestConvertToPng:
    ...
    def test_imagemagick_failure_preserves_original(self, tmp_path, failure):
        ...
        with patch.dict(sys.modules, {"PIL": None, "PIL.Image": None}):
            with patch("mercury_cli.clipboard.subprocess.run", side_effect=side_effect):
