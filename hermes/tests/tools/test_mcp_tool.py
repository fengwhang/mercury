...
class TestLoadMCPConfig:
    ...
    def test_portable_servers_merge_after_native_interpolation(self):
        ...
        with (
            patch("mercury_cli.config.load_config", return_value={"mcp_servers": native}),
            patch("mercury_cli.plugins.discover_plugins"),
            patch("mercury_cli.plugins.get_plugin_manager", return_value=manager),
