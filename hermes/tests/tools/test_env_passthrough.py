...
class TestTerminalIntegration:
    ...
    def test_passthrough_cannot_override_internal_dynamic_secret(self):
        """A skill must NOT be able to register dynamically-named Mercury
    ...
    def test_provider_blocklist_import_failure_fails_closed(self, monkeypatch):
        ...
        otherwise a skill could tunnel a Mercury credential into the
        ...
        it out of the child env. A non-Mercury key is also rejected here (the
