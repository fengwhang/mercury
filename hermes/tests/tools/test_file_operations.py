...
class TestIsWriteDenied:
    ...
    def test_oauth_traversal_denied(self, path):
        ...
        full_path = str(mercury_home / path)
    ...
    def test_pairing_dir_denied(self, tmp_path, monkeypatch):
        ...
        PR #30383 introduced ~/.mercury/pairing/{platform}-approved.json as the
...
class TestEscapeNativeToolArg:
    ...
    (/c/Users/...) that _escape_shell_arg produces, but Mercury sets
