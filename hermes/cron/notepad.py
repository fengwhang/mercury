...
Write path is the CLI (``mercury cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`mercury cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `mercury cron notepad {job_id} delete "
