...
export const en: Translations = {
  ...
  boot: {
    ready: 'Mercury Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Mercury settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Mercury backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Mercury Desktop…'
    },
    errors: {
      backgroundExited: 'Mercury background process exited.',
      backgroundExitedDuringStartup: 'Mercury background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Mercury backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Mercury',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Mercury Desktop.',
    ...
    native: {
      ...
      inputBody: 'Mercury is waiting for your response.',
      turnDoneTitle: 'Mercury finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Mercury defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Mercury backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Mercury backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Mercury is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Mercury asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Mercury was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Mercury was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Mercury follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Mercury can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Mercury when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Mercury walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Mercury is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Mercury, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Mercury Desktop',
      attribution: 'Mercury is a hybrid distribution of Hermes by Nous Research and omp by can1357.',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Mercury runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Mercury checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Mercury configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Mercury.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Mercury gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Mercury Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Mercury Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Mercury runtime managed by this app.',
      kindRemoteDesc: 'A Mercury gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Mercury Cloud account.',
      kindSshDesc: 'A Mercury install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Mercury manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Mercury Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Mercury backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Mercury backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Mercury backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Mercury Cloud',
      cloudDesc: 'Sign in once to Mercury Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Mercury Cloud',
      cloudSignIn: 'Sign in to Mercury Cloud',
      cloudSignedIn: 'Signed in to Mercury Cloud',
      cloudNeedsSignIn: 'Sign in to Mercury Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Mercury Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Mercury Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Mercury Cloud',
      cloudSignedOutMessage: 'Cleared the Mercury Cloud session.',
      ...
      restartingMessage: 'Mercury Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Mercury ${version}` : ''}`,
      ...
      sshDesc:
        'Mercury is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Mercury path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Mercury found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Mercury runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Mercury is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Mercury path.',
      sshErrPlatform:
        'Unsupported remote platform. Mercury Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Mercury on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Mercury. Review the exact configuration below — it comes from the link, not from Mercury.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Mercury runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Mercury at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Mercury builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Mercury to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Mercury to generate pets.',
      backgroundHint: 'You can close this — Mercury will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Mercury desktop' },
    ...
    hermesActiveSessions: (version, count) => `Mercury ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Mercury you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Mercury environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Mercury did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Mercury will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Mercury backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Mercury. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Mercury backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Mercury...',
    placeholderReconnecting: 'Reconnecting to Mercury…',
    ...
    attachUrlDesc: 'Mercury will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Mercury to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Mercury…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Mercury…',
    ...
    unsupportedMessage: 'This version of Mercury can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Mercury is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Mercury backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Mercury from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Mercury will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Mercury desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Mercury updater takes over in its own window and reopens Mercury automatically when it’s done. Please don’t reopen Mercury yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Mercury reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Mercury reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Mercury?',
    blockerBody:
      'Mercury needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Mercury',
    foreignBlockerBody:
      'Mercury can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Mercury can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Mercury needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Mercury Desktop',
    setupChoiceDesc:
      'Connect this app to a Mercury gateway you already run, or install Mercury locally on this computer.',
    connectExistingTitle: 'Connect to existing Mercury',
    ...
    installLocalTitle: 'Install Mercury locally',
    installLocalDesc: 'Download Mercury, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Mercury Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Mercury',
    remoteSetupDesc: 'Enter your gateway URL. Mercury Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Mercury gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Mercury gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Mercury',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Mercury CLI or desktop instance is running. Stop any running Mercury instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Mercury installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Mercury",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Mercury is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Mercury…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Mercury',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Mercury at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Mercury connects automatically',
    ...
    authorizeThere: 'Authorize Mercury there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Mercury there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Mercury Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Mercury Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Mercury will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Mercury is restarting...',
      askRestart: 'Ask Mercury to restart the server',
      lookingRestart: taskId => `Mercury is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Mercury is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Mercury to open a page.',
      finishedRestarting: message => `Mercury finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Mercury could not restart the server.',
      stillWorking:
        'Mercury is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Mercury is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Mercury gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Mercury won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Mercury needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Mercury needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Mercury Desktop to use Save Image.',
    restartToSaveImages: 'Restart Mercury Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Mercury loads when the work calls for them.'
      },
      messaging: {
        title: 'Mercury away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Mercury made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Mercury — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
