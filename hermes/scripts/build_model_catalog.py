#!/usr/bin/env python3
"""Build the Mercury Model Catalog — a centralized JSON manifest of curated models.
...
Mercury CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Mercury release.
...
``https://mercury-agent.nousresearch.com/docs/api/model-catalog.json``
"""
...
os.environ.setdefault("HERMES_HOME", os.path.join(os.path.expanduser("~"), ".mercury"))

from mercury_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "mercury-agent repo",
            "docs": "https://mercury-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Mercury '
