...
def main() -> None:
    ...
    mercury_home = Path(tempfile.mkdtemp(prefix="mercury-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "mercury-gateway-smoke",
    ...
    print(json.dumps({"mercury_home": str(mercury_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
