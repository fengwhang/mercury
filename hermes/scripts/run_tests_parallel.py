...
#                        nousresearch/mercury-agent:test image, via
...
def _run_one_file_once(
    ...
    env = os.environ.copy()
    temproot = tempfile.mkdtemp(prefix="mercury-pytest-tmproot-")
...
def _format_file(file: Path, repo_root: Path) -> str:
    ...
    ``/home/runner/work/mercury-agent/mercury-agent/tests/acp/test_auth.py``.
