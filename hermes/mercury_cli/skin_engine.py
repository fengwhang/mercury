"""Mercury skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Mercury itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.mercury/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.mercury/skins/ therefore
...
.. code-block:: yaml
    ...
    colors:
      ...
      banner_border: "#B22222"            # Panel border color
      banner_title: "#FF6347"             # Panel title text color
      ...
      ui_tool: "#FF4500"                 # Tool-call markers (● / spinner); falls back to ui_accent
      ...
      syntax_string: "#FF4500"           # Code strings; falls back to ui_accent
    ...
    branding:
      agent_name: "Mercury"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! 🌡️"              # Shown on exit
      response_label: " 🌡️ Mercury "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Mercury"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Mercury — orangered and kawaii",
        # Dark-authored. Values match the TUI's DARK_THEME so the classic CLI
        # and the TUI render the same Mercury orangered.
        "colors": {
            "banner_border": "#B22222",
            "banner_title": "#FF6347",
            ...
            "prompt": "#FFF5EE",
            "input_rule": "#B22222",
            "response_border": "#FF6347",
            "status_bar_bg": "#1a1a2e",
            "status_bar_text": "#C0C0C0",
            "status_bar_strong": "#FF6347",
            "status_bar_dim": "#8A7A4A",
            "status_bar_good": "#8FBC8F",
            "status_bar_warn": "#FFA500",
            "status_bar_bad": "#FF8C00",
            "status_bar_critical": "#FF6B6B",
            "session_label": "#FF69B4",  # HERMES-OMP PATCH: pink by default (Mercury session identity); skins override
        ...
        "branding": {
            "agent_name": "Mercury",
            "welcome": "Welcome to Mercury! Type your message or /help for commands.",
            "goodbye": "Goodbye! 🌡️",
            "response_label": " 🌡️ Mercury ",
            "prompt_symbol": "❯",
