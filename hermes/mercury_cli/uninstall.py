...
def _perform_uninstall(
    *,
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            # no Windows installer is published for Mercury yet; point at the
            # repo, never at upstream hermes.
            print(color("  https://github.com/fengwhang/mercury (see README)", Colors.DIM))
        else:
            print(color(
