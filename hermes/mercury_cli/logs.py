...
Usage examples::
    ...
    mercury logs gui -f            # follow gui.log (dashboard/pty/ws)
    mercury logs desktop -f        # follow desktop.log (Electron app boot/backend)
...
def tail_log(
    ...
    *,
    ...
    if not log_path.exists():
        ...
        print("(Logs are created when Mercury runs — try 'mercury chat' first)")
        sys.exit(1)
