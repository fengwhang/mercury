"""
Mercury CLI - Unified command-line interface for Mercury.
...
def _ensure_utf8():
    ...
    can even start — e.g. `mercury setup` on a fresh Pi.
    ...
    mercury_cli/stdio.py::configure_windows_stdio() runs later from the entry
