...
def auth_add_command(args) -> None:
    ...
    if provider == "nous":
        ...
        # <mercury-root>/shared/nous_auth.json (written by any previous
        # successful login), offer to import it instead of running the
        # full device-code flow. This makes `mercury --profile <name>
    ...
    if provider == "openai-codex":
        ...
        # latest login: a second ``mercury auth add openai-codex`` overwrote
    ...
    if provider == "xai-oauth":
        ...
        # The singleton round-trip collapsed every added account into the
        # latest login: a second ``mercury auth add xai-oauth`` overwrote the
