"""Image-authored deployment provenance for immutable Mercury runtimes.

The published image bakes ``/etc/mercury/image-provenance.json`` outside both
...
IMAGE_PROVENANCE_PATH = Path("/etc/mercury/image-provenance.json")
