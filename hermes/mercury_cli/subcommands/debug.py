"""``mercury debug`` subcommand parser.
...
def build_debug_parser(subparsers, *, cmd_debug: Callable) -> None:
    ...
    debug_parser = subparsers.add_parser(
        ...
        description="Debug utilities for Mercury. Use 'mercury debug share' to "
        "upload a debug report (system info + recent logs) to a paste "
        "service and get a shareable URL.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""\
Examples:
    mercury debug share              Upload debug report (asks for confirmation)
    mercury debug share --yes        Skip confirmation (for scripts/CI)
    ...
    mercury debug share --no-redact  Disable upload-time secret redaction
    mercury debug share --nous       Upload to Nous-internal storage (private)
