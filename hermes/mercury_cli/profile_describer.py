...
Used by ``mercury profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``mercury_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Mercury kanban board.
...
Rules:
  ...
  - Never write "Mercury profile" or other meta-narration.
...
def describe_profile(
    ...
    *,
    ...
    try:
        if canon == "default":
            from mercury_constants import get_hermes_home  # type: ignore
