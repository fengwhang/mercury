...
``tests/mercury_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Mercury dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Mercury</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://mercury-agent.nousresearch.com/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
