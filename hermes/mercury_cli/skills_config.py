"""
Skills configuration for Mercury.
...
from mercury_cli.config import cfg_get, load_config, save_config
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    ...
    Essential skills (e.g. ``mercury-agent``) are silently dropped from the
