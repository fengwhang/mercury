"""Durable aggregation and local export for Mercury shared metrics."""
...
from mercury_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "mercury.shared_metrics.v2"
...
class SharedMetricsStore:
        ...
        return [
            {
                ...
                "resource": {
                    "mercury_version": row["mercury_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Mercury processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "mercury_version": period_row["mercury_version"],
