"""Relay subscriber for the persisted Mercury shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Mercury counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Mercury shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
