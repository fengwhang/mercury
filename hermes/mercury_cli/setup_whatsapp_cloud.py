...
Entry point: ``mercury whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``mercury_cli/main.py``).
...
Mercury gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Mercury to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Mercury needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Mercury gateway in another terminal:")
    print("         mercury gateway")
    print()
    ...
    print()
    print("  Docs: https://mercury-agent.nousresearch.com/docs/user-guide/")
