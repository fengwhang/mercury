"""Client for uploading ``mercury debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``mercury debug share``.
...
_USER_AGENT = "mercury-agent/debug-share"
