...
the get_anchored_view / get_messages_around primitives in mercury_state.
...
from mercury_state_common import _RESET_END_REASONS
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search past Mercury sessions (FTS5 over the local session DB), or read/"
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Mercury profile's database "
