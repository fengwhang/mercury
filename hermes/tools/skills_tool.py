...
# Cache validation (mirrors mercury_cli/profiles.py::_count_skills, d5eee133e):
...
def load_env() -> Dict[str, str]:
    ...
    # the canonical readers in mercury_cli/config.py).
                ...
                return json.dumps(
                    {
                        ...
                        "hint": (
                            ...
                            "the repo with `mercury skills untrust`."
                        ),
                    },
                    ensure_ascii=False,
                )
            ...
            try:
                ...
                if is_org_mirror_path(skill_dir, active_skills_dir):
                    ...
                    header = (
                        ...
                        "them back with\n"
                        "> `mercury sync propose` (or automatically, if your "
                        "org enables it).\n\n"
                    )
