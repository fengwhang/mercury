...
def _is_hermes_provider_credential(name: str) -> bool:
    ...
    let a skill tunnel a Mercury credential into the execute_code child.
    """
    try:
        ...
        return True
    # Dynamically-generated Mercury-internal secrets (AUXILIARY_*_API_KEY /
    ...
    try:
        ...
        if isinstance(passthrough, list):
            for item in passthrough:
                ...
                # Mercury-managed provider credentials must not be passed
                ...
                if _is_hermes_provider_credential(name):
                    logger.warning(
                        "env passthrough: refusing to register Mercury "
