...
def auth_json_path():
    """Return the Mercury auth store path, respecting HERMES_HOME overrides."""
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`mercury tools`, banner/status paint, provider
...
# managed vendor's gateway URL is pinned: adding one is a Mercury release, and
