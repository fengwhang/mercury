#!/usr/bin/env python3
"""Apply a layout preset in the Mercury desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the Mercury desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the Mercury desktop app when the user "
