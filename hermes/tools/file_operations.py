...
class ShellFileOperations(FileOperations):
    ...
    def _escape_native_tool_arg(self, arg: str) -> str:
        ...
        paths — and Mercury disables MSYS argument conversion for its bash
    ...
    def _atomic_write(self, path: str, content: str) -> "ExecuteResult":
        ...
        ``.mercury-tmp`` file next to the user's data, and the original file
        ...
        tmpl = self._escape_shell_arg(".mercury-tmp.XXXXXX")
        ...
        script = (
            ...
            '|| mktemp "$d/.mercury-tmp.$$.XXXXXX" 2>/dev/null '
            '|| { tmp="$d/.mercury-tmp.$$"; : > "$tmp" && echo "$tmp"; })"; '
    ...
    def write_file(self, path: str, content: str,
        ...
        # clean the temp up on any failure so we never leak a ``.mercury-tmp``
    ...
    def _search_with_rg(self, pattern: str, path: str, file_glob: Optional[str],
        ...
        # nothing converts back — Mercury sets MSYS_NO_PATHCONV for its bash).
