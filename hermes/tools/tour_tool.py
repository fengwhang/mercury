#!/usr/bin/env python3
"""Run a guided tour (highlight + narrate UI elements) in the Mercury desktop GUI.
...
- ``surface="app"`` — the Mercury desktop app's own DOM (tours of Mercury itself).
...
def tour_tool(
    ...
    if callback is None:
        return tool_error("tour is only available in the Mercury desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (Mercury itself) "
