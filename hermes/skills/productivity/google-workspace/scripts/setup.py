#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for Mercury.
...
def install_deps():
    ...
    # Fallback: the interpreter has no pip (the Mercury Docker image's venv is
    ...
    print(
        "On environments without pip (e.g. Nix, or the Mercury Docker image's "
