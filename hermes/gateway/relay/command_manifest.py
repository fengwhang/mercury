...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Mercury session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Mercury session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Mercury agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Mercury to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Mercury gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Mercury session in it",
