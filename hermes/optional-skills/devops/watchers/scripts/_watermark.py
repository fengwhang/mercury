...
def _state_dir() -> Path:
    ...
    # Default: $HERMES_HOME/watcher-state/, falling back to ~/.mercury/watcher-state/.
    mercury_home = os.environ.get("HERMES_HOME") or str(Path.home() / ".mercury")
    return Path(mercury_home) / "watcher-state"
