...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        # atexit.register(_drain_token_queue_at_exit) (mercury_state.py), which only
...
def _(rid, params: dict) -> dict:
    ...
    # ``mercury --tui`` session legitimately rides the real stdio transport and
    # must stay visible.
...
def _(rid, params: dict) -> dict:
    ...
    transfer is performed by the separate ``mercury gateway`` process, whose
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from agent.pet import store
        from mercury_cli.pets import _clear_active_if
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        if new_slug != slug:
            try:
                from mercury_cli.pets import _rename_active_if
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from mercury_cli.pets import _set_enabled
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from mercury_cli.pets import set_pet_scale
...
def _(rid, params: dict) -> dict:
    ...
    from mercury_cli.nous_billing import BillingError, post_subscription_preview
...
def _(rid, params: dict) -> dict:
    ...
    billing:manage.
    """
    from mercury_cli.nous_billing import BillingError, put_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    """
    from mercury_cli.nous_billing import BillingError, delete_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    from mercury_cli.nous_billing import BillingError, post_subscription_upgrade
...
def _(rid, params: dict) -> dict:
    ...
    """
    from mercury_cli.nous_billing import BillingError, get_charge_status
...
def _(rid, params: dict) -> dict:
    ...
    """
    from mercury_cli.nous_billing import BillingError, patch_auto_top_up
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from mercury_cli.nous_billing import BillingError
...
def _(rid, params: dict) -> dict:
    ...
    agent = session["agent"]
    # Mirror the classic CLI /save: snapshot under the Mercury profile home
    # (~/.mercury/sessions/saved/) rather than the project/workspace CWD, and
    ...
    path = saved_dir / f"mercury_conversation_{timestamp}.json"
