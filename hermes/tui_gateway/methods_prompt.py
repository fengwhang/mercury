...
def _(rid, params: dict) -> dict:
    from mercury_cli.input_sanitize import sanitize_user_prompt_text
                ...
                try:
                    ...
                    if hosted or peer:
                        return _err(
                            ...
                            + "Update Mercury Desktop to continue it.",
                        )
    ...
    # over another app when they are back in Mercury.
        ...
        if (
            ...
            if not is_truthy_value(params.get("confirm_truncate")):
                ...
                return _err(
                    ...
                    "(update your Mercury client if a rewind was intended)",
                )
...
def _(rid, params: dict) -> dict:
    ...
    prompt = "\n".join(
        ...
        for line in [
            ...
            "Restart exactly the app intended for the Preview URL, not Mercury Desktop itself.",
            ...
            "First inspect what process, if any, owns the Preview URL port. If a stale server exists, inspect its cwd and prefer that cwd over the Mercury/Desktop process cwd.",
            ...
            "Before declaring success, verify the Preview URL responds with the intended app, not Mercury Desktop. If it serves Mercury/Desktop UI or another unrelated app, stop that process and report failure.",
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the Mercury
