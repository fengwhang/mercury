...
//
//   - thinking: hidden — HERMES-OMP PATCH (drive fix): reasoning traces are
//     noise-by-default in Mercury; chat, tool calls, and outputs stay on
//     screen. `/details thinking expanded` (or display.sections.thinking in
//     config.yaml) restores the live-transcript style.
//   - tools: expanded — tool calls + outputs stay visible (the useful part).
