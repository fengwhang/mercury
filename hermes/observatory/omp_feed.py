...
3. keeps per-subagent byte offsets for ``get_subagent_messages``
   ...
   one stopped (``restore_offsets``).

The listener runs on the client's reader thread; events cross onto the
