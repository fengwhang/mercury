"""
A2A (Agent-to-Agent) plugin for Mercury.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Mercury as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`mercury gateway setup` flow for A2A."""
    ...
    print_info("Expose Mercury as an A2A-discoverable agent and call other A2A agents.")
