...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Mercury gateway adapter.

    Each inbound phone number gets its own Mercury session (multi-tenant).
...
# static dict in mercury_cli/gateway.py, and the _send_sms dispatch in
