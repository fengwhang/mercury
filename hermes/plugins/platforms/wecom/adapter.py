        ...
        *,
        ...
        if is_final:
            try:
                ...
                # resend.  Mercury' prior behaviour — raising RuntimeError so
...
_QR_CODE_PAGE = "https://work.weixin.qq.com/ai/qc/gen?source=mercury&scode="
...
def qr_scan_for_bot_info(
    *,
    ...
    generate_url = f"{_QR_GENERATE_URL}?source=mercury"
...
# wizard + _PLATFORMS["wecom"] static dict in mercury_cli/gateway.py, and the
...
def interactive_setup() -> None:
    ...
    Replaces mercury_cli/gateway.py::_setup_wecom and the static
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `mercury setup` to install WeCom support.",
