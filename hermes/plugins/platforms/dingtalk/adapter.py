...
class DingTalkAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {
            "msgtype": "markdown",
            "markdown": {"title": "Mercury", "text": normalized},
        }
...
# dict in mercury_cli/gateway.py, and the _send_dingtalk dispatch in
...
def interactive_setup() -> None:
    ...
    Replaces mercury_cli/setup.py-era _setup_dingtalk + the static
    _PLATFORMS["dingtalk"] dict in mercury_cli/gateway.py. CLI helpers are
