...
required — uses aiohttp which is already a Mercury dependency.
...
def interactive_setup() -> None:
    ...
    ``mercury_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # mercury_cli/setup.py::_setup_mattermost function.
