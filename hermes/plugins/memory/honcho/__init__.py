...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, mercury_home):
        ...
        config_path = Path(mercury_home) / "honcho.json"
        existing = {}
    ...
    def _start_session_init_background(self, *, wait_timeout: float = 0.0) -> None:
        ...
        This keeps Mercury CLI/gateway startup responsive when Honcho is down,
        ...
        with self._init_lock:
            ...
            init_session_id = self._lazy_init_session_id or "mercury-default"
    ...
    def _do_session_init(self, cfg, session_id: str, **kwargs) -> None:
        ...
        # Skip under per-session strategy: every Mercury run creates a fresh
    ...
    def _ensure_session(self) -> bool:
        ...
        try:
            self._do_session_init(
                self._config,
                self._lazy_init_session_id or "mercury-default",
    ...
    def _pop_auth_notice(self) -> str:
        ...
        return (
            ...
            "'mercury honcho setup' to re-authenticate will restore it."
        )
