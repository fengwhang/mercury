...
Behavioral settings (live in $HERMES_HOME/mem0.json, set via `mercury memory
setup`):
  ...
  agent_id           — Agent identifier (default: mercury)
...
def _load_config() -> dict:
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "mercury"),
        "oss": {},
    }
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def post_setup(self, mercury_home: str, config: dict) -> None:
        ...
        post_setup(mercury_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent_id = self._config.get("agent_id", "mercury")
