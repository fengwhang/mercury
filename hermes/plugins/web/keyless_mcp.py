...
two endpoints so a fresh Mercury install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``mercury tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `mercury tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `mercury tools` for reliable service."
            ),
        }
