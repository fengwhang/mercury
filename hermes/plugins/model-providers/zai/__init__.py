...
request omits ``thinking``.  Mercury' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Mercury reasoning
...
(per Z.AI / BigModel docs).  Mercury' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Mercury reasoning effort onto GLM's native vocabulary.
