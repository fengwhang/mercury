...
``_check_spotify_available()`` — when the user has not run ``mercury auth
spotify``, the tools remain registered (so they appear in ``mercury
...
The Spotify auth flow (``mercury auth spotify``), CLI plumbing, and docs
