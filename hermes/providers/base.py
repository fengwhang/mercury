...
def _profile_user_agent() -> str:
    """Return a ``mercury-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from mercury_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"mercury-cli/{_ver}"
    except Exception:
        return "mercury-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # mercury-cli UA so the catalog endpoint is reachable.
