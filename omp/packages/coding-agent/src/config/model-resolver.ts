...
export const DEFAULT_PREWALK_TARGET = "*"; // HERMES-OMP PATCH: session model (roles dead)
...
export function resolveModelRoleValue(
	...
	// HERMES-OMP PATCH: role routing is KILLED. Every role value resolves to
	// "no override" → the caller keeps the session model. Explicit
