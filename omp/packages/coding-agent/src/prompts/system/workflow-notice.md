...
- `completion(prompt, *, model="default", system=None, schema=None)`: oneshot stateless model call; no tools/history. Tier: `"default"` — the session model. Use for cheap fan-out classification/scoring.
