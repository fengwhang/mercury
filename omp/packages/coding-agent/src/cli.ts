...
// HERMES-OMP PATCH (tool-provider union): stdin/stdout JSON bridge selector
// for external processes (the hermes side of Mercury) to use omp's web
// search/scrape provider registry.
